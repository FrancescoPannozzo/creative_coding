...
public class OrologioPanCambiaColoreOgniMinTotal extends PApplet {
...
public void draw() {
  ...
  if (inSec) {
    ...
    if ( second() == 0) {
      ...
      rc = PApplet.parseInt(random(255));
      gc = PApplet.parseInt(random(255));
      bc = PApplet.parseInt(random(255));
    }
  }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "OrologioPanCambiaColoreOgniMinTotal" };
    if (passedArgs != null) {
